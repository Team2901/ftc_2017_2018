...
@Disabled
@Autonomous(name = "RoverRuckusAutonomousWebcacm Blue Crater")
public class RoverRuckusAutonomousBlueCraterWebcam extends LinearOpMode {
    ...
    public void dropFromLander() {
        telemetry.addData("dropFromLander", "");
        telemetry.update();
