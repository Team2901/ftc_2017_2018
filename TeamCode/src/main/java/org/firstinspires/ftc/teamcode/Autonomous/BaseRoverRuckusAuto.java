...
public class BaseRoverRuckusAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        */
        ...
        PolarCoord preJewelPosition = getPreJewelPosition(goldPosition, initialPosition);
        PolarCoord depotPosition = getDepotPosition(initialPosition);
        PolarCoord craterPosition = getCraterPosition(initialPosition);
        PolarCoord jewelPosition = getJewelPosition(goldPosition, initialPosition);
...
// Starts to slow down by .01 per angle closer to the goal.
    ...
    public PolarCoord getPreJewelPosition(GoldPosition goldPostition, StartPosition startPostition) {
